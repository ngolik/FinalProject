 ...
 * @author Nikita Golik
 */
public class ConnectionPoolMovie {
    private static Logger logger = LogManager.getLogger(ConnectionPoolMovie.class);
    ...
    private static ConnectionPoolMovie instance = new ConnectionPoolMovie();

    public static ConnectionPoolMovie getInstance() {
        return instance;
    }
